...
Begin VB.Form ABMTipoFactura 
   BackColor       =   &H80000004&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "ABM de Tipo de Factura"
   ClientHeight    =   4395
   ClientLeft      =   1245
   ClientTop       =   2355
   ClientWidth     =   6495
   ...
   Begin VB.CommandButton cmdNuevo 
      Caption         =   "&Nuevo"
      DisabledPicture =   "ABMTipoFactura.frx":0000
      Height          =   735
      Left            =   3780
      Picture         =   "ABMTipoFactura.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   3615
      Width           =   870
   ...
   Begin VB.CommandButton cmdGrabar 
      Caption         =   "&Aceptar"
      DisabledPicture =   "ABMTipoFactura.frx":0614
      Height          =   735
      Left            =   2895
      Picture         =   "ABMTipoFactura.frx":091E
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   3615
      Width           =   870
   ...
   Begin VB.CommandButton CmdSalir 
      Caption         =   "&Salir"
      DisabledPicture =   "ABMTipoFactura.frx":0C28
      Height          =   735
      Left            =   5550
      Picture         =   "ABMTipoFactura.frx":0F32
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   3615
      Width           =   870
   ...
   Begin VB.CommandButton cmdBorrar 
      Caption         =   "&Eliminar"
      DisabledPicture =   "ABMTipoFactura.frx":123C
      Height          =   735
      Left            =   4665
      Picture         =   "ABMTipoFactura.frx":1546
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   3615
      Width           =   870
   ...
   Begin TabDlg.SSTab tabDatos 
      ...
      EndProperty
      TabCaption(0)   =   "&Datos"
      TabPicture(0)   =   "ABMTipoFactura.frx":1850
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "fraDatos"
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "&Buscar"
      TabPicture(1)   =   "ABMTipoFactura.frx":186C
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton CmdBuscAprox 
            ...
            Left            =   5535
            MaskColor       =   &H000000FF&
            Picture         =   "ABMTipoFactura.frx":1888
            Style           =   1  'Graphical
            TabIndex        =   7
            ToolTipText     =   "Buscar"
            Top             =   210
      ...
      Begin VB.Frame fraDatos 
         Caption         =   " Datos del Tipo de Factura"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "ABMTipoFactura"
...
ValidarIngreso = True
For Each Control In ABMTipoFactura.Controls ' revisar los controles del form
...
Private Sub cmdBorrar_Click()
       If TxtCodigo.Text <> "" Then
            ...
            resp = MsgBox("Seguro desea eliminar el Tipo de Factura: " & Trim(txtDescri.Text) & " ?", 36, "Eliminar:")
            If resp <> 6 Then Exit Sub
            
            Screen.MousePointer = 11
            lblEstado.Caption = "Eliminando ..."
            
            sql = "DELETE FROM TIPO_FACTURA WHERE tfa_codigo = " & XN(TxtCodigo)
            DBConn.Execute sql
            lblEstado.Caption = ""
...
Private Sub CmdBuscAprox_Click()
    ...
    If Trim(TxtDescriB) <> "" Then sql = sql & "WHERE TFA_DESCRI LIKE '" & Trim(TxtDescriB) & "%'"
    sql = sql & " ORDER BY TFA_DESCRI"
...
Private Sub CmdSalir_Click()
        Unload Me
        Set ABMTipoFactura = Nothing
End Sub

Private Sub cmdGrabar_Click()
    If txtDescri.Text = "" Then
        MsgBox "Debe ingreasr la descripción", vbExclamation, TIT_MSGBOX
        txtDescri.SetFocus
        Exit Sub
    End If
    On Error GoTo ErrorTrans
    ...
    Else
        ...
        sql = sql & " SET tfa_descri = " & XS(txtDescri.Text)
        sql = sql & " WHERE tfa_codigo = " & XN(TxtCodigo)
...
Private Sub txtCodigo_LostFocus()
    If Me.TxtCodigo.Text <> "" Then
        Set rec = New ADODB.Recordset
        sql = "select * from tipo_factura where tfa_codigo =  " & XN(TxtCodigo.Text)
        rec.Open sql, DBConn, adOpenStatic, adLockOptimistic
        If rec.EOF = False Then
           txtDescri.Text = Trim(rec!tfa_descri)
           cmdBorrar.Enabled = True
        Else
