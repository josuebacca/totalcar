...
Private Function ValidarNotaCredito() As Boolean
    ...
    If txtNroNotaCredito.Text = "" Then
        MsgBox "Debe ingresar el Número de Nota de Crédito", vbExclamation, TIT_MSGBOX
...
Private Sub cmdImprimir_Click()
    If MsgBox("¿Confirma Impresión Nota de Crédito?", vbQuestion + vbYesNo, TIT_MSGBOX) = vbNo Then Exit Sub
...
Public Sub ImprimirEncabezado()
 '-----------IMPRIME EL ENCABEZADO DE LA NOTA DE CREDITO-------------------
    ...
    Imprimir 15.8, 1, False, "NOTA DE CRÉDITO"
    'año = String(4, Year(FechaNotaCredito))
    año = Year(FechaNotaCredito)
...
Private Sub Form_Load()
    ...
    GrdModulos.FormatString = "^Tipo|^Número|^Fecha|Importe|Cliente|Domicilio|Cod_Estado|" _
