...
Begin VB.Form ABMTransporte 
   ...
   Begin VB.CommandButton CmdSalir 
      ...
      Height          =   720
      Left            =   4950
      Picture         =   "ABMTransporte.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   3480
      Width           =   840
   ...
   Begin VB.CommandButton CmdBorrar 
      Caption         =   "&Eliminar"
      DisabledPicture =   "ABMTransporte.frx":030A
      Enabled         =   0   'False
      Height          =   720
      Left            =   4095
      Picture         =   "ABMTransporte.frx":0614
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   3480
      Width           =   840
   ...
   Begin VB.CommandButton CmdNuevo 
      ...
      Height          =   720
      Left            =   3240
      Picture         =   "ABMTransporte.frx":091E
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   3480
      Width           =   840
   ...
   Begin VB.CommandButton CmdGrabar 
      Caption         =   "&Guardar"
      DisabledPicture =   "ABMTransporte.frx":0C28
      Enabled         =   0   'False
      Height          =   720
      Left            =   2385
      Picture         =   "ABMTransporte.frx":0F32
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   3480
      Width           =   840
   ...
   Begin TabDlg.SSTab TabTB 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton CmdBuscAprox 
            ...
            Left            =   4770
            MaskColor       =   &H000000FF&
            Picture         =   "ABMTransporte.frx":1274
            Style           =   1  'Graphical
            TabIndex        =   7
            ToolTipText     =   "Buscar"
            Top             =   225
   ...
   End
End
Attribute VB_Name = "ABMTransporte"
...
Private Sub CmdBorrar_Click()
    ...
    If Trim(TxtCodigo) <> "" Then
        resp = MsgBox("Seguro desea eliminar el Transporte: " & Trim(TxtDescrip) & "? ", 36, "Eliminar:")
        If resp <> 6 Then Exit Sub
        
        Screen.MousePointer = 11
        lblEstado.Caption = "Eliminando ..."
        
        DBConn.Execute "DELETE FROM TRANSPORTE WHERE TRS_CODIGO = " & XN(TxtCodigo)
        lblEstado.Caption = ""
...
Private Sub CmdBuscAprox_Click()
    ...
    Screen.MousePointer = 11
    Me.Refresh
    sql = "SELECT TRS_CODIGO,TRS_DESCRI FROM TRANSPORTE "
    If Trim(TxtDescriB) <> "" Then sql = sql & "WHERE TRS_DESCRI LIKE '%" & Trim(TxtDescriB) & "%'"
    sql = sql & " ORDER BY TRS_DESCRI"
...
Private Sub cmdGrabar_Click()
    ...
    If TxtCodigo.Text <> "" Then
        ...
        sql = sql & " SET TRS_DESCRI = " & XS(TxtDescrip)
        sql = sql & " WHERE TRS_CODIGO = " & XN(TxtCodigo)
        DBConn.Execute sql
        
    Else
        TxtCodigo = "1"
        sql = "SELECT MAX(TRS_CODIGO) as maximo FROM TRANSPORTE"
        rec.Open sql, DBConn, adOpenStatic, adLockOptimistic
        If Not IsNull(rec.Fields!Maximo) Then TxtCodigo = XN(rec.Fields!Maximo) + 1
        rec.Close
        
        sql = "INSERT INTO TRANSPORTE(TRS_CODIGO,TRS_DESCRI) "
        sql = sql & " VALUES ("
...
Private Sub TxtCodigo_LostFocus()
    If TxtCodigo.Text <> "" Then
        ...
        rec.Open sql, DBConn, adOpenStatic, adLockOptimistic
        If rec.EOF = False Then
         TxtDescrip.Text = rec!TRS_DESCRI
        Else
