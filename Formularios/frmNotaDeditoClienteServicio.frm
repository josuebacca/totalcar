...
Begin VB.Form frmNotaDeditoClienteServicio 
   ...
   Caption         =   "Nota de Débito Clientes por Servicio..."
   ClientHeight    =   7650
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   11280
   ...
   Begin TabDlg.SSTab tabDatos 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.CommandButton cmdAgregarProducto 
            ...
            Left            =   10485
            MaskColor       =   &H8000000F&
            Picture         =   "frmNotaDeditoClienteServicio.frx":30F8
            Style           =   1  'Graphical
            TabIndex        =   63
            TabStop         =   0   'False
...
Private Sub cmdGrabar_Click()
    ...
    If rec.EOF = True Then
        ...
        sql = sql & " NDC_OBSERVACION,NDC_NUMEROTXT,NDC_SUBTOTAL,NDC_TOTAL,NDC_BONIPESOS, EST_CODIGO,NDC_SALDO)"
        sql = sql & " VALUES ("
...
Dim año As String
    ...
    Imprimir 15.8, 1, False, "NOTA DE DEBITO"
    año = Year(FechaNotaDebito)
    ...
    sql = sql & ", P.PRO_DESCRI,CI.IVA_CODIGO,CI.IVA_DESCRI"
...
'        'Imprimir 1, 6.3, False, Trim(Rec1!IVA_DESCRI)
    ...
    End If
    Rec1.Close
'    Imprimir 1.8, 7.2, False, " SERVICIOS"
...
Private Sub Form_Load()
    ...
    grdGrilla.FormatString = "Código|Descripción|Cantidad|Precio|Bonif.|Pre.Bonif.|Importe|Orden"
    ...
    GrdModulos.FormatString = "^Tipo|^Número|^Fecha|Importe|Cliente|Cod_Estado|" _
    ...
    GrdModulos.ColWidth(3) = 1200 'Importe  SEGUIR ACA!!!!!!
    GrdModulos.ColWidth(4) = 4800 'CLIENTE
...
Private Sub txtCodCliente_LostFocus()
    If txtCodCliente.Text <> "" Then
        ...
        If Rec1.EOF = False Then
            ...
            txtProvincia.Text = IIf(IsNull(Rec1!PRO_DESCRI), "", Rec1!PRO_DESCRI)
            txtCliLocalidad.Text = IIf(IsNull(Rec1!LOC_DESCRI), "", Rec1!LOC_DESCRI)
...
Private Sub txtPorcentajeIva_LostFocus()
    ...
    For I = 1 To grdGrilla.Rows - 1
        If grdGrilla.TextMatrix(I, 0) = "7" Then
            totGastos = grdGrilla.TextMatrix(I, 6)
        End If
    Next
    ...
    If txtPorcentajeIva.Text <> "" And txtSubtotal.Text <> "" Then
        ...
        If txtImporteBoni.Text <> "" Then
            ...
            txtTotal.Text = Valido_Importe(txtTotal.Text)
        Else
            txtImporteIva.Text = (totGastos * CDbl(txtPorcentajeIva.Text)) / 100
            txtImporteIva.Text = Valido_Importe(txtImporteIva.Text)
