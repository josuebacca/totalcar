...
Begin VB.Form ABMTipoCuenta 
   ...
   Begin VB.CommandButton CmdSalir 
      Caption         =   "&Salir"
      DisabledPicture =   "ABMTipoCuenta.frx":0000
      Height          =   735
      Left            =   4950
      Picture         =   "ABMTipoCuenta.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   3030
      Width           =   855
   ...
   Begin VB.CommandButton CmdBorrar 
      Caption         =   "&Eliminar"
      DisabledPicture =   "ABMTipoCuenta.frx":0614
      Height          =   735
      Left            =   4080
      Picture         =   "ABMTipoCuenta.frx":091E
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   3030
      Width           =   855
   ...
   Begin VB.CommandButton CmdNuevo 
      Caption         =   "&Nuevo"
      DisabledPicture =   "ABMTipoCuenta.frx":0C28
      Height          =   735
      Left            =   3210
      Picture         =   "ABMTipoCuenta.frx":0F32
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   3030
      Width           =   855
   ...
   Begin VB.CommandButton CmdGrabar 
      Caption         =   "&Aceptar"
      DisabledPicture =   "ABMTipoCuenta.frx":123C
      Height          =   735
      Left            =   2340
      Picture         =   "ABMTipoCuenta.frx":1546
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   3030
      Width           =   855
   ...
   Begin TabDlg.SSTab TabTB 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton CmdBuscAprox 
            ...
            Left            =   4890
            MaskColor       =   &H000000FF&
            Picture         =   "ABMTipoCuenta.frx":1888
            Style           =   1  'Graphical
            TabIndex        =   7
            ToolTipText     =   "Buscar"
            Top             =   210
      ...
      Begin VB.Frame Frame3 
         Caption         =   " Datos del Tipo de Cuenta"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "ABMTipoCuenta"
...
Private Sub CmdBorrar_Click()
    ...
    If Trim(TxtCODIGO) <> "" Then
        ...
        resp = MsgBox("Seguro desea eliminar el Tipo de Cuenta: " & Trim(TxtDescrip) & "? ", 36, "Eliminar:")
...
Private Sub CmdBuscAprox_Click()
    ...
    If Trim(TxtDescriB) <> "" Then sql = sql & "WHERE TCU_DESCRI LIKE '%" & Trim(TxtDescriB) & "%'"
    rec.Open sql, DBConn, adOpenStatic, adLockOptimistic
    If rec.RecordCount > 0 Then
        rec.MoveFirst
